...
let toastCount = 0
document.body.appendChild(new DOMParser().parseFromString(`<div class="toast-container position-fixed pt-5 top-0 translate-middle-x start-50" style="z-index: 2000"></div>`, 'text/html').querySelector('.toast-container'))
